...
import com.fastcampus.projectboardamdin.config.TestSecurityConfig;
...
@Import(SecurityConfig.class) // Duplicate mock definition 발생하기 때문에 TestSecurityConfig 사용 불가능
